...
| `FORWARD_RECONSTRUCTION_COMPARISON/` | [`FORWARD_RECONSTRUCTION_COMPARISON.md`](../FORWARD_RECONSTRUCTION_COMPARISON.md) | `forward_reconstruction_comparison.png` |
| `IMPERFECT_INVERSE_PINN/` | [`IMPERFECT_INVERSE_PINN.md`](../IMPERFECT_INVERSE_PINN.md) | `imperfect_inverse_pinn.png` |
